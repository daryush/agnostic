...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'exchange.exchange_propositions' => 'getExchange_ExchangePropositionsService',
            'exchange.items' => 'getExchange_ItemsService',
            'exchange.items_handler' => 'getExchange_ItemsHandlerService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('P8Q9K8oDZi', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cc8bOI48VJ', 0, 'oew1n+8IKToTa8Lo5Sa-Us', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'agnostic-mysql', 'port' => 'vagrant', 'dbname' => 'vagrant', 'user' => 'vagrant', 'password' => 'vagrant', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/src/AppBundle/Resources/config/doctrine') => 'Exchange\\Model'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Exchange\\Model');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('Exchange' => 'Exchange\\Model'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_a790cb1183df67b414411d3596d6f7895d591c08d54708fbb2c475b3a7af0145');
    ...
    /**
     * Gets the 'exchange.exchange_propositions' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Exchange\Infrastructure\Doctrine\ExchangePropositions A Exchange\Infrastructure\Doctrine\ExchangePropositions instance
     */
    protected function getExchange_ExchangePropositionsService()
    {
        return $this->services['exchange.exchange_propositions'] = new \Exchange\Infrastructure\Doctrine\ExchangePropositions($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'exchange.items' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Exchange\Infrastructure\Doctrine\Items A Exchange\Infrastructure\Doctrine\Items instance
     */
    protected function getExchange_ItemsService()
    {
        return $this->services['exchange.items'] = new \Exchange\Infrastructure\Doctrine\Items($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'exchange.items_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Exchange\Application\UserItemHandler A Exchange\Application\UserItemHandler instance
     */
    protected function getExchange_ItemsHandlerService()
    {
        return $this->services['exchange.items_handler'] = new \Exchange\Application\UserItemHandler($this->get('exchange.items'), $this->get('exchange.exchange_propositions'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ff13ef383a354a1d2788a1571ee99709d8607a92');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HDb2lyPGsl', 0, 'oew1n+8IKToTa8Lo5Sa-Us', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58ef2794109fb8.12140889')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_host' => 'agnostic-mysql',
            'database_port' => 'vagrant',
            ...
            'secret' => 'ff13ef383a354a1d2788a1571ee99709d8607a92',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'ff13ef383a354a1d2788a1571ee99709d8607a92',
